...
const FUNCTIONS_INITIAL = [
  { id: "ifmis", name: "Financial management information system", pillar: "Core financials", type: "Process execution", weight: 1.5, en: "integrated financial management, IFMIS, GIFMIS, financial management information system, general ledger, treasury information system", fr: "gestion des finances publiques, SIGIF, SIGFiP, système intégré de gestion, comptabilité publique, chaîne de la dépense" },
  { id: "treasury", name: "Treasury management", pillar: "Treasury", type: "Government controls", weight: 1.3, en: "treasury, treasury single account, TSA, cash management", fr: "trésor, compte unique du trésor, gestion de la trésorerie" },
  { id: "budget_exec", name: "Budget execution", pillar: "Budget", type: "Process execution", weight: 1.2, en: "budget execution, commitment control, warrant, expenditure control", fr: "exécution budgétaire, engagement des dépenses, contrôle des dépenses" },
  { id: "revenue", name: "Revenue administration", pillar: "Revenue", type: "Process execution", weight: 1.2, en: "tax administration, revenue authority, domestic tax, ITAS, customs", fr: "administration fiscale, impôts, régie financière, douanes, recettes" },
  { id: "procurement", name: "Public procurement", pillar: "Procurement", type: "Process execution", weight: 1.1, en: "e-procurement, electronic procurement, procurement system", fr: "dématérialisation des marchés publics, système de passation des marchés" },
  { id: "coa", name: "Chart of accounts", pillar: "Core financials", type: "Government controls", weight: 1.1, en: "chart of accounts, classification structure, budget classification", fr: "plan comptable, nomenclature budgétaire" },
  { id: "payroll", name: "Payroll and HR", pillar: "Human resources", type: "Process execution", weight: 1.0, en: "payroll, IPPIS, HRMIS, human resource management information", fr: "paie, solde, gestion des ressources humaines, fichier du personnel" },
  { id: "debt", name: "Debt management", pillar: "Treasury", type: "Policy", weight: 0.9, en: "debt management, DMFAS, public debt", fr: "gestion de la dette, dette publique" },
  { id: "audit", name: "Audit and controls", pillar: "Controls", type: "Government controls", weight: 0.9, en: "internal audit, audit management, internal control", fr: "audit interne, contrôle interne, inspection des finances" },
  { id: "budget_prep", name: "Budget preparation", pillar: "Budget", type: "Policy", weight: 0.8, en: "budget preparation, budget planning, medium-term expenditure", fr: "préparation du budget, programmation budgétaire, cadre de dépenses à moyen terme" },
  { id: "assets", name: "Asset management", pillar: "Assets", type: "Government controls", weight: 0.8, en: "fixed assets, asset register, asset management", fr: "patrimoine de l'État, immobilisations" },
  { id: "transparency", name: "Fiscal transparency", pillar: "Transparency", type: "Fiscal transparency", weight: 0.6, en: "fiscal transparency, open budget, citizens budget, budget portal", fr: "transparence budgétaire, budget citoyen" },
];
const LEXICON_LANGS = ["en", "fr"];
const SYSTEM_NAMES = ["IFMIS", "GIFMIS", "IPPIS", "TSA", "HRMIS", "ITAS", "e-procurement", "SIGIF", "SIGFiP", "AGFIS", "ISFU", "SIGMAP"];
...
const PRODUCT_MAP = { ifmis: "Core Accountability", coa: "Core Accountability", audit: "Core Accountability", assets: "Core Accountability", treasury: "Treasury Management", debt: "Treasury Management", budget_exec: "Public Expenditures", budget_prep: "Public Expenditures", procurement: "Public Expenditures", revenue: "Revenue and Taxation", payroll: null, transparency: null };
      ...
      {stages.map((s, i) => (
        <div key={s.label} className="flex items-stretch gap-1.5 flex-1 min-w-0">
          ...
          <div className="flex-1 min-w-0">
            <div className="rounded-md flex items-end" style={{ height: 56, background: C.panel, border: `1px solid ${C.border}` }}>
              <div className="w-full rounded-b-md flex items-start justify-center pt-1" style={{ height: `${Math.max(18, (s.value / max) * 100)}%`, background: s.color + "26", borderTop: `2px solid ${s.color}` }}>
                <span className="text-base font-semibold tabular-nums" style={{ color: s.color }}>{s.value}</span>
              </div>
            </div>
